...
def tars(lang, use_sounds):
    notify = Notification('tars')
...
if __name__ == '__main__':
    import argparse
    parser = argparse.ArgumentParser(description='tars: control PC with your voice')
    ...
    if args.list_commands:
        ...
        LoudSoundTrigger(tars, args.lang, args.sounds).run_and_wait(single_run=False)
    else:
        tars(args.lang, args.sounds)
